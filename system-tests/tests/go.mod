...
require (
	...
	github.com/smartcontractkit/chainlink-ccip/chains/evm v0.0.0-20260428205619-2db1389501a1 // indirect
...
require (
	...
	github.com/smartcontractkit/chainlink-evm v0.3.4-0.20260429123911-44d13c62c6e1 // indirect
